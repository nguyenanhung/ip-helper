...
echo "Helper ipValidate: " . ipValidate('172.217.31.238') . PHP_EOL;
echo "Helper ipValidateV4: " . ipValidateV4('172.217.31.238') . PHP_EOL;
...
echo "Helper getIpInformation: " . getIpInformation('172.217.31.238') . PHP_EOL;
